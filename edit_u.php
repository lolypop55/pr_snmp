		...
		<div class="page">
			...
			<div class="body">
				<div>
					...
					<div>
					  <h3>&nbsp;</h3><center>
					  <form name="form1" method="post" action="add_u.php">
  Add Router<br>
  <table width="478" border="1" style="width: 600px">
    <tbody>  <tr>
      ...
      <tr>
        ...
        <td width="305"><input type="text" name="Username" id="Username"></td>
      </tr>
       <tr>
        <td width="157"> &nbsp;Name</td>
        <td width="305"><input type="text" name="Name" id="Name"></td>
      </tr>
       <tr>
        <td width="157"> &nbsp;Status</td>
        <td width="305"><input type="text" name="Status" id="Status"></td>
      </tr>
	   </tr>
       <tr>
