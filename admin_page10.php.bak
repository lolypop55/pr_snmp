                        ...
                        <div>
                            <h3>&nbsp;</h3><center>
                                ...
                                <table width="400" border="0" cellspacing="1" cellpadding="0">
                                    <tr>
                                        <td><form action="admin_page10.php" method="post" >
                                                <table width="950" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
                                                    ...
                                                    while ($rows = mysql_fetch_array($result)) {
                                                        ...
                                                        $snmpSysDescr = snmpwalk($rows['Router_IP'], "public", "1.3.6.1.2.1.1.1");
                                                        if (!$isDown) {
                                                            $snmpSysUptime = snmpget($rows['Router_IP'], "public", "sysUpTime.0");
		                                                    $snmpSysName = snmpwalk($rows['Router_IP'], "public", "1.3.6.1.2.1.1.5");
                                                            $snmpSysLocation = snmpwalk($rows['Router_IP'], "public", "1.3.6.1.2.1.1.6");
                                                        }
                                                        ?>
                                                        ...
                                                        ?></td>
                                                            <td bgcolor="#FFFFFF"><?php if ($isDown){
																...
																/*
																//echo $snmpSysUptime;
                                                                //echo eregi_replace("Timeticks:","",$snmpSysUptime[0]);
																$sysupre = eregi_replace("([0-9]{3})","",$snmpSysUptime);
